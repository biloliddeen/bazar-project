                ...
                <div class="container my-auto">
                    <div class="row">
                            ...
                            <div class="col text-right">
                                Created by <a href="http://t.me/abdullaev_571" target="_blank">Abdullaev Group</a>
                            </div>
                    </div>
                </div>
            </footer>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" data-method="post" href="<?php echo \yii\helpers\Url::to(['/site/logout'])?>">
                        Logout
                    </a>
                </div>
            </div>
