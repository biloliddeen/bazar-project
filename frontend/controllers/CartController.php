...
class CartController extends Controller
{
    ...
    public function actionChangeQuantity(){
        ...
        \Yii::$app->session->get(CartItem::SESSION_KEY, $cartItems);
        ...
        return [
                ...
                'price' => Yii::$app->formatter->asCurrency( CartItem::getTotalPriceForUser(currUserId())),
        ];
    }
    ...
    public function actionCheckout(){
        ...
        $orderAddress = new \common\models\OrderAddress;
    ...
    public function actionSubmitPayment($orderId)
    {
        ...
        if ($response->statusCode === 200) {
            ...
            if ($paidAmount === (float)$order->total_price && $response->result->status === 'PAID') {
