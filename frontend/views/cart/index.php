...
<div class="card ">
    <div class="card-header">
        <h3>
          <?php echo \Yii::t('app', 'Your cart items'); ?>
        </h3>
    </div>
    ...
    <table class="table table-hover">
        ...
        <tbody>
            <?php foreach($items as $item):?>
                <tr data-id="<?php echo $item['id']; ?>" data-url="<?php echo \yii\helpers\Url::to(['/cart/change-quantity']);?>">
                    ...
                    <td>
                        <img src=" <?php echo Product::formatImageUrl($item['image']);?>" alt="<?php echo $item['name']?>" width="60">    
                    </td>
        ...
        <div class="card-body text-right">
            <a href="<?php echo \yii\helpers\Url::to(['/cart/checkout'])?>" class="btn btn-primary"> <?php echo \Yii::t('app', 'Checkout') ?></a>
        </div>
    </div>
</div>
<?php else:?>
